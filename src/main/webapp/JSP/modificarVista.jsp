...
<html>
    ...
    <body class="principal">
        ...
        <form action="${contexto}/ModificarController" method="post" class="formulario-modificar">
            <table class="tabla-visualizar">
                ...
                <c:forEach var="usuario" items="${sessionScope.usuarios}">
                    ...
                    <tr>
                        <td><input type="radio" name="modificarUsuario" value="${usuario.id}"> </td>        
            ...
            <div class="modificar-botones">
                <input type="submit" name="botonModificar" value="Realizar" class="boton">
